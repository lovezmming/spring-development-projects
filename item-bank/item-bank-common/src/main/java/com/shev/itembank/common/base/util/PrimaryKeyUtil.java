...
public class PrimaryKeyUtil
{
    ...
    public static String nextId(Boolean isPublic, String tenantId, DataServiceEnum dataServiceEnum)
    {
        return new StringBuilder(isPublic?1:2).append(TextUtil.expandNum(Integer.valueOf(tenantId), "0", 6))
                .append(TextUtil.expandNum(Integer.valueOf(dataServiceEnum.getServiceId()), "0", 6))
                .append(TextUtil.expandNum(random.nextInt(999999), "0", 6))
