...
public enum EnumResourceType4ELXX
{
    ...
    private EnumResourceType4ELXX(byte id, String name)
    {
        _id = id;
        _name = name;
    }
    ...
    public final static EnumResourceType4ELXX getByResourceSuffix(String suffix)
    {
